...
extern "C" {
    ...
    pub fn ovr_CreateTextureSwapChainGL(session: ovrSession,
                                        desc: *const ovrTextureSwapChainDesc,
                                        out_TextureSwapChain:
                                            *mut ovrTextureSwapChain)
     -> ovrResult;
    pub fn ovr_GetTextureSwapChainBufferGL(session: ovrSession,
                                           chain: ovrTextureSwapChain,
                                           index: ::std::os::raw::c_int,
                                           out_TexId:
                                               *mut ::std::os::raw::c_uint)
     -> ovrResult;
    pub fn ovr_CreateMirrorTextureGL(session: ovrSession,
                                     desc: *const ovrMirrorTextureDesc,
                                     out_MirrorTexture: *mut ovrMirrorTexture)
     -> ovrResult;
    pub fn ovr_GetMirrorTextureBufferGL(session: ovrSession,
                                        mirrorTexture: ovrMirrorTexture,
                                        out_TexId:
                                            *mut ::std::os::raw::c_uint)
     -> ovrResult;
